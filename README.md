...
vars:
  ...
  ansistrano_gcs_url: http://rgw.example.com # when use Ceph RGW, set url
  # Optional variables, omitted by default
  ansistrano_gcs_aws_access_key: YOUR_AWS_ACCESS_KEY
  ansistrano_gcs_aws_secret_key: YOUR_AWS_SECRET_KEY
